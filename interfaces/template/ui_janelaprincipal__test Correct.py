...
from PySide6.QtWidgets import (QApplication, QMainWindow, QMdiArea, QMenu,
    QMenuBar, QSizePolicy, QVBoxLayout, QWidget, QMdiSubWindow)

from interfaces.template.ui_cadastro_pessoas__test_Corret import Ui_cadastro_funcionario
...
class Ui_janelaPrincipal(object):
    def setupUi(self, janelaPrincipal):
        ...
        janelaPrincipal.resize(650, 430)
        janelaPrincipal.setMinimumSize(QSize(650, 430))
        ...
        self.actionFuncion_rio = QAction(janelaPrincipal)
        ...
        subwindow.setWindowTitle("Cadastro de Funcionário")
        subwindow.setWidget(Ui_cadastro_funcionario())
        ...
        self.menubar.setGeometry(QRect(0, 0, 650, 25))
        ...
        self.menuPessoa.addAction(self.actionFuncion_rio)
    ...
    def retranslateUi(self, janelaPrincipal):
        ...
        self.actionFuncion_rio.setText(QCoreApplication.translate("janelaPrincipal", u"Funcion\u00e1rio", None))
        ...
        #self.cadastro_funcionario.setWindowTitle(QCoreApplication.translate("janelaPrincipal", u"cadastro_funcionario", None))
